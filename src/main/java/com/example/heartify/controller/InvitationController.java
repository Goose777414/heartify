...
public class InvitationController {
    ...
    /**
     * Відправка запрошення від поточного користувача до прокфілю з profileId
     * Перевіряє, чи вже існує запрошення
     */
    ...
    public String sendInvitation(@PathVariable Long profileId, HttpSession session) {
        ...
        // Не дозволяємо дублікати запрошень
    ...
    public String acceptInvitation(@PathVariable Long id, HttpSession session) {
        ...
        if (invOpt.isPresent()) {
            ...
            // перевіряємо, що current є отримувачем
