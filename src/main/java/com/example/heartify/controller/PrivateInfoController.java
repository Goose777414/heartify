...
/**
 * Controller to handle viewing and editing of private information
...
public class PrivateInfoController {
    ...
    public String viewPrivateInfo(@PathVariable Long profileId,
        ...
        PrivateInfo info = privateInfoRepository.findByProfile(targetProfile)
    ...
    /**
     * Show form to edit private information for the current user.
     */
    ...
    public String showEditPrivateInfo(HttpSession session, Model model) {
        ...
        if (profile == null) {
            // Якщо свого профілю нема — кидаємо на створення
    ...
    /**
     * Process submission of the private information form.
     */
